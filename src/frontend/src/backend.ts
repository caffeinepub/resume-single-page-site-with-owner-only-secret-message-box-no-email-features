...
export class Backend implements backendInterface {
    ...
    async logRecruiterVisit(arg0: boolean, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitVisitorMessage(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVisitorMessage(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_RecruiterVisit_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RecruiterVisit): RecruiterVisit {
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        companyName: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.companyName))
    };
}
...
function from_candid_vec_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RecruiterVisit>): Array<RecruiterVisit> {
    return value.map((x)=>from_candid_RecruiterVisit_n7(_uploadFile, _downloadFile, x));
}
